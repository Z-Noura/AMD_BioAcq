...
void spiAdcInit() {
    ...
    SPI2CON1bits.SPRE = 7;      // Secondary prescaler 1:1 => 10MHz
    ...
    data[0] = 0x0B01;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 0 voltage range +-1.25*Vref ==> +-5V
    data[0] = 0x0D01;           
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 1 voltage range +-1.25*Vref ==> +-5V
    data[0] = 0x0F01;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 2 voltage range +-1.25*Vref ==> +-5V
    data[0] = 0x1101;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 3 voltage range +-1.25*Vref ==> +-5V
	data[0] = 0x1301;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 4 voltage range +-1.25*Vref ==> +-5V
	data[0] = 0x1501;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 5 voltage range +-1.25*Vref ==> +-5V
	data[0] = 0x1701;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 6 voltage range +-1.25*Vref ==> +-5V
	data[0] = 0x1901;
    data[1] = 0;
    adcSpiWriteRead(data, 2);   // Channel 7 voltage range +-1.25*Vref ==> +-5V 
    data[0] = CHANNEL0;
    data[1] = 0;
